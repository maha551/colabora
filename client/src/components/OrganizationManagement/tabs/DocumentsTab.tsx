...
import { FileText, Plus, X, Settings, CheckSquare } from 'lucide-react';
      ...
      {showInlineCreation && permissions.canCreateDocuments && (
        <Card className="border-2 border-blue-200 bg-blue-50 animate-in slide-in-from-top-2 duration-300">
          <CardHeader className="pb-3">
            ...
            <CardDescription>
              Create a document proposal that requires organizational approval before being added to the structure.
            </CardDescription>
          </CardHeader>
